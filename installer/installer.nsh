...
; --- License/Activation page is disabled ---
; To re-enable, uncomment the customHeader macro and the functions below.
...
;     ${NSD_CreateLabel} 0 0 100% 30u "Enter your activation key below:"
;     Pop $0
...
;         ; valid
;     ${Else}
;         MessageBox MB_OK|MB_ICONSTOP "Invalid license key."
;         Abort
;     ${EndIf}
; FunctionEnd
...
!macro preInit
    ; Block installation on Windows XP and below (Win7+ only)
    ${IfNot} ${AtLeastWin7}
